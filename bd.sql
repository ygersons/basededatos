...
CREATE TABLE n_cliente 
 (id                         VARCHAR(3)  NOT NULL,
  ...
  CONSTRAINT n_cliente_historial_crediticio_ck
  CHECK (historial_crediticio IN ('EXCELENTE', 'BUENO', 'POOR'))
 );


INSERT INTO n_cliente VALUES ('301', 'Sports,Inc', '540-123-4567','72 High St',
'Harrisonburg', 'VA','US', '22809','EXCELENTE', '12', '1', NULL);
INSERT INTO n_cliente VALUES ('302', 'Toms Sporting', '540-987-6543','6741 Main St',
...
INSERT INTO n_cliente VALUES ('403', 'Athletics One', '717-234-6786','912 Columbia Rd',
'Lancaster', 'PA','US', '17601','BUENO', '14', '1', NULL);
INSERT INTO n_cliente VALUES ('404', 'Great Athletes', '717-987-2341','121 Litiz Pike',
'Lancaster', 'PA','US', '17602','EXCELENTE', '12', '1', NULL);
INSERT INTO n_cliente VALUES ('405', 'Athletics Two', '717-987-9875','435 High Rd',
'Lancaster', 'PA','US', '17602','EXCELENTE', '14', '1', NULL);
INSERT INTO n_cliente VALUES ('406', 'Athletes Attic', '717-234-9888','101 Greenfield Rd',
'Lancaster', 'PA','US', '17601','POOR', '12', '1', NULL);

INSERT INTO n_cliente VALUES ('201', 'One Sport', '55-112066222','82 Via Bahia', 'Sao Paolo',
NULL, 'Brazil', NULL,'EXCELENTE', '12', '2', NULL);
INSERT INTO n_cliente VALUES ('202', 'Deportivo Caracas', '58-28066222','31 Sabana Grande',
'Caracas', NULL, 'Venezuela', NULL,'EXCELENTE', '12', '2', NULL);
INSERT INTO n_cliente VALUES ('203', 'New Delhi Sports', '91-11903338','11368 Chanakya',
...
INSERT INTO n_cliente VALUES ('209', 'Beisbol Si!', '809-352666','415 Playa Del Mar',
 'San Pedro de Macoris', NULL, 'Dominican Republic', NULL, 'EXCELENTE', '11', '6', NULL);
INSERT INTO n_cliente VALUES ('210', 'Futbol Sonora', '52-404555','5 Via Saguaro', 'Nogales',
NULL, 'Mexico', NULL,'EXCELENTE', '12', '2', NULL);
INSERT INTO n_cliente VALUES ('211', 'Helmut''s Sports', '42-2111222','45 Modrany', 'Prague',
NULL, 'Czechoslovakia', NULL,'EXCELENTE', '11', '5', NULL);
INSERT INTO n_cliente VALUES ('212', 'Hamada Sport', '20-31209222','47A Corniche', 
'Alexandria', NULL, 'Egypt', NULL,'EXCELENTE', '13', '3', NULL);
INSERT INTO n_cliente VALUES ('213', 'Sports Emporium', '1-415-555-6281','4783 168th Street',
'San Francisco', 'CA', 'US', NULL,'EXCELENTE', '11', '1', NULL);
INSERT INTO n_cliente VALUES ('214', 'Sports Retail', '1-716-555-7777','115 Main Street',
